...
sns.scatterplot(x='carat', y='price', data=df_filtered, hue='cut', palette='viridis')
plt.title('Zależność między rozmiarem a ceną z uwzględnieniem jakości szlifu')
st.pyplot(plt)
...
X_selected = sm.add_constant(X[selected_features])  # Dodanie stałej do modelu
